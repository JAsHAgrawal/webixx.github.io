...
function changeimg() {
  ...
  '<div  id="addmenu"style="margin-left: 50px;padding:1em 1em 1em 1em;justify-content:center; width: fit-content; height : fit-content;"><form onsubmit="return false;"><p style="cursor:pointer;" onclick="CLOSE_img_MENU()">X</p><input type="text" style="margin:5px 5px 5px 5px; border-radius:20px;font-size:16px;" id="myimg" placeholder="enter your url here"><input type="file" style="margin:5px 5px 5px 5px; border-radius:20px;font-size:16px;" id="imginp" name="img" accept="image/*"><br>solid color<br><input type="color" style="border-radius:10px" id="bgcolor" value="#ffffff"><input type="submit" style="margin-left:80px;padding:3px 3px 3px 3px;width:auto;border-radius:20px" onclick="changeimgapp()"></form> </div>';
...
function add_menu() {
  ...
  '<div class="well" id="addmenu"style="margin-left: 50px; width: fit-content"><ul class="option"><li class="item"><p style="align:right;cursor:pointer;"onclick="close_add_menu()">X</p></li><li class="item"><a href="#" onclick="text_types()" id="texts">TEXT</a></li><li class="item" ><a href="#" id="buts" onclick="but_types()" >BUTTONS</a></li><li><a href="#" id="imgs">IMAGES</a></li></ul></div>';
